...
const SWSE_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  Raticate: {otherFormes: ['Raticate-Alola', 'Raticate-Alola-Totem', 'Raticate-Kaskade']},
  'Raticate-Kaskade': {
    types: ['Normal', 'Ice'],
    bs: {hp: 55, at: 50, df: 70, sa: 81, sd: 70, sp: 87},
    weightkg: 25.5,
    abilities: {0: 'Ice Body'},
    baseSpecies: 'Raticate',
  },
  ...
  Bellsprout: {otherFormes: ['Bellsprout-Kaskade']},
  'Bellsprout-Kaskade': {
    types: ['Grass'],
    bs: {hp: 50, at: 70, df: 40, sa: 40, sd: 30, sp: 70},
    weightkg: 4,
    nfe: true,
    abilities: {0: 'Sweet Veil'},
    baseSpecies: 'Bellsprout',
  },
  'Nidoran-F': {abilities: {0: 'Poison Coat'}},
  Nidorina: {abilities: {0: 'Poison Coat'}},
  Nidoqueen: {abilities: {0: 'Poison Coat'}},
  'Nidoran-M': {abilities: {0: 'Poison Coat'}},
  Nidorino: {abilities: {0: 'Poison Coat'}},
  Nidoking: {abilities: {0: 'Poison Coat'}},
  Vulpix: {abilities: {0: 'Solar Power'}},
  'Vulpix-Alola': {abilities: {0: 'Absolute Zero'}},
  Ninetales: {types: ['Fire', 'Ghost'], abilities: {0: 'Solar Power'}},
  'Ninetales-Alola': {abilities: {0: 'Absolute Zero'}},
  'Ponyta-Galar': {abilities: {0: 'Power Above'}},
  'Rapidash-Galar': {abilities: {0: 'Power Above'}},
  Slowpoke: {abilities: {0: 'Sweet Dreams'}},
  Slowbro: {abilities: {0: 'Sweet Dreams'}},
  'Grimer-Alola': {abilities: {0: 'Poison Coat'}},
  'Muk-Alola': {abilities: {0: 'Poison Coat'}},
  Gastly: {otherFormes: ['Gastly-Kaskade']},
  'Gastly-Kaskade': {
    types: ['Ghost', 'Water'],
    bs: {hp: 30, at: 35, df: 40, sa: 80, sd: 25, sp: 100},
    weightkg: 2,
    nfe: true,
    abilities: {0: 'Levitate'},
    baseSpecies: 'Gastly',
  },
  Haunter: {otherFormes: ['Haunter-Kaskade']},
  'Haunter-Kaskade': {
    types: ['Ghost', 'Water'],
    bs: {hp: 45, at: 50, df: 60, sa: 95, sd: 40, sp: 115},
    weightkg: 5,
    nfe: true,
    abilities: {0: 'Levitate'},
    baseSpecies: 'Haunter',
  },
  Gengar: {otherFormes: ['Gengar-Gmax', 'Gengar-Mega', 'Gengar-Kaskade']},
  'Gengar-Kaskade': {
    types: ['Ghost', 'Water'],
    bs: {hp: 65, at: 55, df: 85, sa: 110, sd: 55, sp: 130},
    weightkg: 35,
    abilities: {0: 'Levitate'},
    baseSpecies: 'Gengar',
  },
  'Exeggutor-Alola': {abilities: {0: 'Power Within'}},
  Seadra: {abilities: {0: 'Poison Coat'}},
  Jynx: {otherFormes: ['Jynx-Kaskade']},
  'Jynx-Kaskade': {
    types: ['Psychic', 'Fighting'],
    bs: {hp: 65, at: 115, df: 90, sa: 35, sd: 50, sp: 100},
    weightkg: 40.6,
    abilities: {0: 'Dancer'},
    baseSpecies: 'Jynx',
  },
  Gyarados: {types: ['Water', 'Dragon']},
  Lapras: {otherFormes: ['Lapras-Kaskade']},
  'Lapras-Kaskade': {
    types: ['Ice', 'Dragon'],
    bs: {hp: 110, at: 70, df: 55, sa: 105, sd: 75, sp: 120},
    weightkg: 220,
    abilities: {0: 'Multiscale'},
    baseSpecies: 'Lapras',
  },
  ...
  Azumarill: {otherFormes: ['Azumarill-Kaskade']},
  'Azumarill-Kaskade': {
    types: ['Water', 'Grass'],
    bs: {hp: 100, at: 20, df: 80, sa: 90, sd: 80, sp: 50},
    weightkg: 30,
    abilities: {0: 'Drizzle'},
    baseSpecies: 'Azumarill',
  },
  Sudowoodo: {otherFormes: ['Sudowoodo-Amaze-All']},
  'Sudowoodo-Amaze-All': {
    types: ['Steel', 'Psychic'],
    bs: {hp: 70, at: 40, df: 75, sa: 100, sd: 105, sp: 20},
    weightkg: 115,
    abilities: {0: 'Lightning Rod'},
    baseSpecies: 'Sudowoodo',
  },
  Yanma: {otherFormes: ['Yanma-Kaskade']},
  'Yanma-Kaskade': {
    types: ['Bug', 'Dragon'],
    bs: {hp: 65, at: 65, df: 45, sa: 75, sd: 45, sp: 95},
    weightkg: 38,
    nfe: true,
    abilities: {0: 'Power Within'},
    baseSpecies: 'Yanma',
  },
  Slowking: {abilities: {0: 'Sweet Dreams'}},
  Qwilfish: {abilities: {0: 'Poison Coat'}},
  'Qwilfish-Hisui': {abilities: {0: 'Poison Coat'}},
  Swinub: {abilities: {0: 'Thick Fat'}},
  Piloswine: {abilities: {0: 'Thick Fat'}},
  Skarmory: {abilities: {0: 'Machine Precision'}},
  Exploud: {otherFormes: ['Exploud-Kaskade']},
  'Exploud-Kaskade': {
    types: ['Normal', 'Steel'],
    bs: {hp: 104, at: 81, df: 73, sa: 101, sd: 73, sp: 58},
    weightkg: 84,
    abilities: {0: 'Punk Rock'},
    baseSpecies: 'Exploud',
  },
  Azurill: {otherFormes: ['Azurill-Kaskade']},
  'Azurill-Kaskade': {
    types: ['Water', 'Grass'],
    bs: {hp: 50, at: 20, df: 40, sa: 20, sd: 40, sp: 20},
    weightkg: 2,
  ...
  Spinda: {abilities: {0: 'Tangled Feet'}},
  Vibrava: {abilities: {0: 'Sand Rush'}},
  Flygon: {abilities: {0: 'Sand Rush'}},
  Swablu: {types: ['Flying']},
  Milotic: {types: ['Water', 'Fairy']},
  Castform: {otherFormes: [
    'Castform-Rainy', 'Castform-Snowy', 'Castform-Sunny',
    'Castform-Shady', 'Castform-Sandy', 'Castform-Dusty',
    'Castform-Allergy', 'Castform-Swarmy', 'Castform-Smoggy',
    'Castform-Lovely', 'Castform-Gutsy', 'Castform-Spooky',
    'Castform-Zenny', 'Castform-Sorcery', 'Castform-Zappy',
    'Castform-Windy', 'Castform-Whirly',
  ]},
  'Castform-Shady': {
    types: ['Dark'],
  ...
  'Castform-Whirly': {
    types: ['Steel'],
    bs: {hp: 90, at: 95, df: 95, sa: 95, sd: 95, sp: 95},
    weightkg: 0.8,
    abilities: {0: 'Nullify'},
    baseSpecies: 'Castform',
  },
  Shuppet: {abilities: {0: 'Cursed Body'}},
  Banette: {abilities: {0: 'Cursed Body'}},
  Tropius: {otherFormes: ['Tropius-Kaskade']},
  'Tropius-Kaskade': {
    types: ['Grass', 'Ground'],
    bs: {hp: 110, at: 75, df: 110, sa: 55, sd: 90, sp: 20},
    weightkg: 193.5,
    abilities: {0: 'Root Control'},
    baseSpecies: 'Tropius',
  },
  Absol: {types: ['Dark', 'Fairy'], abilities: {0: 'Anticipation'}},
  Bidoof: {otherFormes: ['Bidoof-Kaskade']},
  'Bidoof-Kaskade': {
    types: ['Steel', 'Normal'],
    bs: {hp: 59, at: 40, df: 40, sa: 35, sd: 45, sp: 31},
    weightkg: 32,
    nfe: true,
    abilities: {0: 'Machine Precision'},
    baseSpecies: 'Bidoof',
  },
  Bibarel: {otherFormes: ['Bibarel-Kaskade']},
  'Bibarel-Kaskade': {
    types: ['Steel', 'Psychic'],
    bs: {hp: 79, at: 50, df: 55, sa: 85, sd: 70, sp: 71},
    weightkg: 58.5,
    abilities: {0: 'Machine Precision'},
    baseSpecies: 'Bibarel',
  },
  Shinx: {otherFormes: ['Shinx-Kaskade']},
  'Shinx-Kaskade': {
    types: ['Ice'],
    bs: {hp: 45, at: 65, df: 34, sa: 40, sd: 39, sp: 45},
    weightkg: 9.5,
    nfe: true,
    abilities: {0: 'Fur Coat'},
    baseSpecies: 'Shinx',
  },
  Luxio: {otherFormes: ['Luxio-Kaskade']},
  'Luxio-Kaskade': {
    types: ['Ice'],
    bs: {hp: 60, at: 85, df: 49, sa: 60, sd: 49, sp: 60},
    weightkg: 30.5,
  ...
  Luxray: {otherFormes: ['Luxray-Kaskade']},
  'Luxray-Kaskade': {
    types: ['Ice', 'Electric'],
    bs: {hp: 80, at: 117, df: 80, sa: 65, sd: 80, sp: 101},
    weightkg: 42,
    abilities: {0: 'Fur Coat'},
    baseSpecies: 'Luxray',
  },
  Vespiquen: {abilities: {0: 'Unnerve'}},
  Ambipom: {otherFormes: ['Ambipom-Kaskade']},
  'Ambipom-Kaskade': {
    types: ['Normal', 'Rock'],
    bs: {hp: 75, at: 100, df: 66, sa: 60, sd: 66, sp: 115},
    weightkg: 20.3,
  ...
  Drifblim: {otherFormes: ['Drifblim-Amaze-All']},
  'Drifblim-Amaze-All': {
    types: ['Ghost', 'Steel'],
    bs: {hp: 150, at: 70, df: 44, sa: 80, sd: 54, sp: 100},
    weightkg: 25,
    abilities: {0: 'Pickup'},
    baseSpecies: 'Drifblim',
  },
  Mismagius: {types: ['Ghost', 'Psychic']},
  Honchkrow: {abilities: {0: 'Malice'}},
  Skuntank: {otherFormes: ['Skuntank-Kaskade']},
  'Skuntank-Kaskade': {
    types: ['Poison', 'Normal'],
    bs: {hp: 103, at: 71, df: 67, sa: 93, sd: 61, sp: 84},
    weightkg: 38,
    abilities: {0: 'Stench'},
    baseSpecies: 'Skuntank',
  },
  Spiritomb: {abilities: {0: 'Malice'}},
  Croagunk: {abilities: {0: 'Trained Eye'}},
  Toxicroak: {abilities: {0: 'Trained Eye'}},
  Snover: {otherFormes: ['Snover-Lowland'], abilities: {0: 'Evergreen'}},
  'Snover-Lowland': {
    types: ['Grass', 'Ground'],
    bs: {hp: 60, at: 62, df: 62, sa: 55, sd: 60, sp: 35},
    weightkg: 43.5,
    nfe: true,
    abilities: {0: 'Evergreen'},
    baseSpecies: 'Snover',
  },
  Abomasnow: {otherFormes: ['Abomasnow-Mega', 'Abomasnow-Lowland'], abilities: {0: 'Evergreen'}},
  'Abomasnow-Lowland': {
    types: ['Grass', 'Ground'],
    bs: {hp: 90, at: 92, df: 92, sa: 85, sd: 85, sp: 50},
    weightkg: 122.5,
    abilities: {0: 'Evergreen'},
    baseSpecies: 'Abomasnow',
  },
  Leafeon: {abilities: {0: 'Chlorophyll'}},
  Glaceon: {abilities: {0: 'Slush Rush'}},
  Mamoswine: {abilities: {0: 'Thick Fat'}},
  Gallade: {abilities: {0: 'Indomitable'}},
  Rotom: {otherFormes: [
    'Rotom-Heat', 'Rotom-Wash', 'Rotom-Frost', 'Rotom-Fan', 'Rotom-Mow',
    'Rotom-Stereo', 'Rotom-Junk', 'Rotom-Sway', 'Rotom-Brawl', 'Rotom-Web', 'Rotom-Sol',
  ]},
  'Rotom-Stereo': {
    types: ['Electric', 'Normal'],
    bs: {hp: 50, at: 65, df: 107, sa: 105, sd: 107, sp: 86},
  ...
  Watchog: {abilities: {0: 'Inner Focus'}},
  Munna: {abilities: {0: 'Dreamer'}},
  Musharna: {abilities: {0: 'Dreamer'}},
  Sewaddle: {abilities: {0: 'Powder Cure'}},
  Swadloon: {abilities: {0: 'Powder Cure'}},
  Leavanny: {abilities: {0: 'Powder Cure'}},
  Excadrill: {otherFormes: ['Excadrill-Mega', 'Excadrill-Kaskade']},
  'Excadrill-Kaskade': {
    types: ['Ground', 'Fairy'],
    bs: {hp: 110, at: 50, df: 65, sa: 135, sd: 60, sp: 88},
    weightkg: 40.4,
    abilities: {0: 'Sand Rush'},
    baseSpecies: 'Excadrill',
  },
  Gurdurr: {otherFormes: ['Gurdurr-Kaskade']},
  'Gurdurr-Kaskade': {
  ...
  Conkeldurr: {otherFormes: ['Conkeldurr-Kaskade']},
  'Conkeldurr-Kaskade': {
    types: ['Fighting', 'Grass'],
    bs: {hp: 105, at: 120, df: 125, sa: 55, sd: 65, sp: 35},
    weightkg: 87,
    abilities: {0: 'Guts'},
    baseSpecies: 'Excadrill',
  },
  Archen: {abilities: {0: 'Sand Rush'}},
  Archeops: {abilities: {0: 'Sand Rush'}},
  'Zorua-Hisui': {abilities: {0: 'Malice'}},
  'Zoroark-Hisui': {abilities: {0: 'Malice'}},
  Solosis: {otherFormes: ['Solosis-Kaskade']},
  'Solosis-Kaskade': {
    types: ['Psychic', 'Water'],
    bs: {hp: 45, at: 30, df: 30, sa: 100, sd: 65, sp: 20},
    weightkg: 1.2,
    nfe: true,
    abilities: {0: 'Overcoat'},
    baseSpecies: 'Solosis',
  },
  Duosion: {otherFormes: ['Duosion-Kaskade']},
  'Duosion-Kaskade': {
    types: ['Psychic', 'Water'],
    bs: {hp: 65, at: 40, df: 55, sa: 100, sd: 80, sp: 30},
    weightkg: 8.3,
    nfe: true,
    abilities: {0: 'Overcoat'},
    baseSpecies: 'Duosion',
  },
  Reuniclus: {otherFormes: ['Reuniclus-Kaskade']},
  'Reuniclus-Kaskade': {
    types: ['Psychic', 'Water'],
    bs: {hp: 110, at: 60, df: 65, sa: 100, sd: 125, sp: 20},
    weightkg: 25.7,
    abilities: {0: 'Overcoat'},
    baseSpecies: 'Reuniclus',
  },
  Ducklett: {abilities: {0: 'Adaptability'}},
  Swanna: {abilities: {0: 'Adaptability'}},
  Klink: {abilities: {0: 'Light Metal'}},
  Klang: {abilities: {0: 'Heavy Metal'}},
  Klinklang: {abilities: {0: 'Ferroflux'}},
  Axew: {abilities: {0: 'Tough Claws'}},
  Fraxure: {abilities: {0: 'Tough Claws'}},
  Haxorus: {types: ['Dragon', 'Steel'], abilities: {0: 'Sharpness'}},
  Cryogonal: {abilities: {0: 'Glacial Armor'}},
  Mienshao: {abilities: {0: 'Reckless'}},
  Golett: {otherFormes: ['Golett-Kaskade']},
  'Golett-Kaskade': {
    types: ['Ghost'],
    bs: {hp: 59, at: 74, df: 50, sa: 35, sd: 50, sp: 35},
    weightkg: 92,
  ...
  Braviary: {types: ['Fighting', 'Flying']},
  Mandibuzz: {abilities: {0: 'Eventide'}},
  Bunnelby: {otherFormes: ['Bunnelby-Kaskade']},
  'Bunnelby-Kaskade': {
    types: ['Ice', 'Normal'],
    bs: {hp: 38, at: 36, df: 38, sa: 32, sd: 36, sp: 57},
    weightkg: 10,
  ...
  Diggersby: {otherFormes: ['Diggersby-Kaskade']},
  'Diggersby-Kaskade': {
    types: ['Ice', 'Normal'],
    bs: {hp: 85, at: 55, df: 87, sa: 54, sd: 77, sp: 65},
    weightkg: 42.4,
    abilities: {0: 'Slush Rush'},
    baseSpecies: 'Diggersby',
  },
  Florges: {types: ['Fairy', 'Grass']},
  Skrelp: {abilities: {0: 'Swift Swim'}},
  Dragalge: {abilities: {0: 'Swift Swim'}},
  'Dragalge-Mega': {abilities: {0: 'Swift Swim'}},
  Helioptile: {abilities: {0: 'Solar Power'}},
  Heliolisk: {abilities: {0: 'Solar Power'}},
  Sylveon: {abilities: {0: 'Pixilate'}},
  Goomy: {types: ['Dragon', 'Water']},
  Sliggoo: {types: ['Dragon', 'Water']},
  Goodra: {types: ['Dragon', 'Water']},
  Phantump: {otherFormes: ['Phantump-Kaskade']},
  'Phantump-Kaskade': {
    types: ['Ghost', 'Poison'],
    bs: {hp: 43, at: 70, df: 48, sa: 50, sd: 60, sp: 38},
    weightkg: 7.2,
  ...
  Trevenant: {otherFormes: ['Trevenant-Kaskade']},
  'Trevenant-Kaskade': {
    types: ['Ghost', 'Poison'],
    bs: {hp: 85, at: 110, df: 76, sa: 65, sd: 82, sp: 56},
    weightkg: 72,
  ...
  Bergmite: {abilities: {0: 'Glacial Armor'}},
  Avalugg: {abilities: {0: 'Glacial Armor'}},
  'Avalugg-Hisui': {abilities: {0: 'Glacial Armor'}},
  Noibat: {abilities: {0: 'Echolocation'}},
  Noivern: {abilities: {0: 'Echolocation'}},
  Diancie: {otherFormes: ['Diancie-Mega', 'Diancie-Kaskade']},
  'Diancie-Kaskade': {
    types: ['Rock', 'Psychic'],
    bs: {hp: 50, at: 120, df: 100, sa: 120, sd: 100, sp: 110},
    weightkg: 8.8,
    gender: 'N',
    abilities: {0: 'Magic Bounce'},
    baseSpecies: 'Diancie',
  },
  Vikavolt: {abilities: {0: 'Energizer'}},
  Crabominable: {otherFormes: ['Crabominable-Mega', 'Crabominable-Kaskade']},
  'Crabominable-Kaskade': {
    types: ['Ice', 'Poison'],
    bs: {hp: 97, at: 132, df: 80, sa: 69, sd: 60, sp: 40},
    weightkg: 180,
    abilities: {0: 'Absolute Zero'},
    baseSpecies: 'Crabominable',
  },
  Cutiefly: {abilities: {0: 'Bloomspring'}},
  Ribombee: {abilities: {0: 'Bloomspring'}},
  'Rockruff-Dusk': {abilities: {0: 'Keen Eye'}},
  Lycanroc: {types: ['Rock', 'Normal']},
  'Lycanroc-Midnight': {types: ['Rock', 'Dark']},
  'Lycanroc-Dusk': {types: ['Rock', 'Fighting'], abilities: {0: 'Keen Eye'}},
  Morelull: {abilities: {0: 'Incantation'}},
  Shiinotic: {abilities: {0: 'Incantation'}},
  Palossand: {otherFormes: ['Palossand-Kaskade']},
  'Palossand-Kaskade': {
    types: ['Ghost', 'Rock'],
    bs: {hp: 85, at: 75, df: 110, sa: 90, sd: 90, sp: 30},
    weightkg: 275,
    abilities: {0: 'Solid Rock'},
    baseSpecies: 'Palossand',
  },
  Bruxish: {otherFormes: ['Bruxish-Kaskade']},
  'Bruxish-Kaskade': {
    types: ['Water'],
    bs: {hp: 78, at: 100, df: 70, sa: 75, sd: 70, sp: 82},
    weightkg: 19,
    abilities: {0: 'Cheek Pouch'},
    baseSpecies: 'Bruxish',
  },
  Corviknight: {abilities: {0: 'Gale Wings'}},
  'Corviknight-Gmax': {abilities: {0: 'Gale Wings'}},
  Dubwool: {otherFormes: ['Dubwool-Kaskade']},
  'Dubwool-Kaskade': {
    types: ['Normal', 'Fire'],
    bs: {hp: 72, at: 80, df: 80, sa: 100, sd: 70, sp: 88},
    weightkg: 43,
    abilities: {0: 'Flash Fire'},
    baseSpecies: 'Dubwool',
  },
  Basculegion: {abilities: {0: 'Shadow Step'}},
  'Basculegion-F': {bs: {at: 80, sa: 112}},
  Oinkologne: {abilities: {0: 'Aroma Veil'}},
  Armarouge: {abilities: {0: 'Weak Armor'}},
  Ceruledge: {abilities: {0: 'Weak Armor'}},
  Varoom: {abilities: {0: 'Filter'}},
  Revavroom: {abilities: {0: 'Filter'}},
...
for (const [, specie] of Object.entries(SV)) {
  if (specie.otherFormes) {
    // @ts-expect-error readonly
    specie.otherFormes = [...new Set(specie.otherFormes)];
    // @ts-expect-error readonly
...
// swse
const SWSE_SPECIES: {[name: string]: SpeciesData} = {
  'Llampas': {
    types: ['Grass'],
    bs: {hp: 65, at: 50, df: 65, sa: 25, sd: 65, sp: 40},
    weightkg: 9.3,
    abilities: {0: 'Overgrow'},
    nfe: true,
  },
  'Danfluff': {
    types: ['Grass'],
    bs: {hp: 90, at: 70, df: 90, sa: 30, sd: 90, sp: 50},
    weightkg: 29.5,
    abilities: {0: 'Overgrow'},
    nfe: true,
  },
  'Alfalphalops': {
    types: ['Grass', 'Rock'],
    bs: {hp: 110, at: 80, df: 115, sa: 50, sd: 115, sp: 60},
    weightkg: 202.5,
    abilities: {0: 'Overgrow'},
  },
  'Therpal': {
    types: ['Fire'],
    bs: {hp: 50, at: 70, df: 40, sa: 40, sd: 40, sp: 70},
    weightkg: 8.3,
    abilities: {0: 'Blaze'},
    nfe: true,
  },
  'Aspfault': {
    types: ['Fire', 'Ground'],
    bs: {hp: 65, at: 90, df: 60, sa: 50, sd: 60, sp: 95},
    weightkg: 21.6,
    abilities: {0: 'Blaze'},
    nfe: true,
  },
  'Tarmendoa': {
    types: ['Fire', 'Ground'],
    bs: {hp: 80, at: 110, df: 75, sa: 60, sd: 75, sp: 130},
    weightkg: 68,
    abilities: {0: 'Blaze'},
  },
  'Burbwhirl': {
    types: ['Water'],
    bs: {hp: 45, at: 70, df: 40, sa: 70, sd: 40, sp: 45},
    weightkg: 4,
    abilities: {0: 'Torrent'},
    nfe: true,
  },
  'Spoutlaw': {
    types: ['Water', 'Bug'],
    bs: {hp: 55, at: 85, df: 60, sa: 85, sd: 50, sp: 85},
    weightkg: 10.9,
    abilities: {0: 'Torrent'},
    nfe: true,
  },
  'Vaquamael': {
    types: ['Water', 'Bug'],
    bs: {hp: 65, at: 90, df: 75, sa: 115, sd: 75, sp: 110},
    weightkg: 44.5,
    abilities: {0: 'Torrent'},
  },
  'Chewmunk': {
    types: ['Normal'],
    bs: {hp: 33, at: 53, df: 36, sa: 35, sd: 44, sp: 49},
    weightkg: 5.5,
    abilities: {0: 'Cheek Pouch'},
    nfe: true,
  },
  'Cheekat': {
    types: ['Normal'],
    bs: {hp: 74, at: 75, df: 71, sa: 49, sd: 67, sp: 84},
    weightkg: 22,
    abilities: {0: 'Cheek Pouch'},
  },
  'Specoey': {
    types: ['Normal', 'Ghost'],
    bs: {hp: 30, at: 56, df: 42, sa: 60, sd: 43, sp: 69},
    weightkg: 5.2,
    abilities: {0: 'Trace'},
    nfe: true,
  },
  'Opakespiel': {
    types: ['Normal', 'Ghost'],
    bs: {hp: 64, at: 76, df: 68, sa: 87, sd: 65, sp: 100},
    weightkg: 11,
    abilities: {0: 'Wandering Spirit'},
  },
  'Kwaile': {
    types: ['Flying'],
    bs: {hp: 48, at: 37, df: 55, sa: 19, sd: 35, sp: 46},
    weightkg: 1.4,
    abilities: {0: 'Shell Armor'},
    nfe: true,
  },
  'Quailert': {
    types: ['Flying', 'Ground'],
    bs: {hp: 81, at: 59, df: 81, sa: 30, sd: 52, sp: 62},
    weightkg: 24.6,
    abilities: {0: 'Big Pecks'},
    nfe: true,
  },
  'Quailstion': {
    types: ['Flying', 'Ground'],
    bs: {hp: 110, at: 90, df: 100, sa: 50, sd: 80, sp: 70},
    weightkg: 52,
    abilities: {0: 'Foil'},
  },
  'Sighlo': {
    types: ['Bug', 'Normal'],
    bs: {hp: 20, at: 15, df: 35, sa: 30, sd: 40, sp: 40},
    weightkg: 2.5,
    abilities: {0: 'Shed Skin'},
    nfe: true,
  },
  'Cooreds': {
    types: ['Bug', 'Normal'],
    bs: {hp: 40, at: 10, df: 50, sa: 45, sd: 45, sp: 25},
    weightkg: 9.9,
    abilities: {0: 'Shed Skin'},
    nfe: true,
  },
  'Probaska': {
    types: ['Bug', 'Normal'],
    bs: {hp: 80, at: 35, df: 80, sa: 80, sd: 70, sp: 100},
    weightkg: 22.3,
    abilities: {0: 'Trumpet Weevil'},
  },
  'Histameanie': {
    types: ['Grass'],
    bs: {hp: 50, at: 85, df: 60, sa: 75, sd: 60, sp: 70},
    weightkg: 6,
    abilities: {0: 'Leaf Guard'},
  },
  'Apheed': {
    types: ['Grass', 'Bug'],
    bs: {hp: 45, at: 20, df: 20, sa: 15, sd: 20, sp: 30},
    weightkg: 2.5,
    abilities: {0: 'Honey Gather'},
    nfe: true,
  },
  'Musleafo': {
    types: ['Grass', 'Bug'],
    bs: {hp: 50, at: 40, df: 40, sa: 40, sd: 30, sp: 50},
    weightkg: 2.6,
    abilities: {0: 'Honey Gather'},
    nfe: true,
  },
  'Eecroach': {
    types: ['Grass', 'Bug'],
    bs: {hp: 70, at: 60, df: 55, sa: 60, sd: 35, sp: 70},
    weightkg: 9.5,
  ...
  'Eecroach-Swarm': {
    types: ['Grass', 'Bug'],
    bs: {hp: 70, at: 120, df: 110, sa: 120, sd: 70, sp: 140},
    weightkg: 44.6,
    abilities: {0: 'Swarming'},
  ...
  'Stackem': {
    types: ['Rock'],
    bs: {hp: 50, at: 75, df: 100, sa: 30, sd: 100, sp: 45},
    weightkg: 60,
  ...
  'Stackem-Rockless': {
    types: ['Rock'],
    bs: {hp: 50, at: 75, df: 100, sa: 30, sd: 100, sp: 80},
    weightkg: 22.9,
    abilities: {0: 'Rocky Body'},
    baseSpecies: 'Stackem',
  },
  'Clamtrip': {
    types: ['Rock', 'Water'],
    bs: {hp: 70, at: 50, df: 40, sa: 80, sd: 50, sp: 100},
    weightkg: 32,
    abilities: {0: 'Pearl Drop'},
  },
  'Rowviar': {
    types: ['Water'],
    bs: {hp: 41, at: 69, df: 40, sa: 40, sd: 30, sp: 60},
    weightkg: 5.2,
    abilities: {0: 'Swift Swim'},
    nfe: true,
  },
  'Sanook': {
    types: ['Water'],
    bs: {hp: 75, at: 125, df: 60, sa: 55, sd: 55, sp: 120},
    weightkg: 82.6,
    abilities: {0: 'Swift Swim'},
  },
  'Cereboral': {
    types: ['Psychic', 'Rock'],
    bs: {hp: 50, at: 50, df: 70, sa: 90, sd: 100, sp: 40},
    weightkg: 22,
    abilities: {0: 'Rain Dish'},
  },
  'Bagoul': {
    types: ['Ghost'],
    bs: {hp: 60, at: 60, df: 70, sa: 90, sd: 70, sp: 90},
    weightkg: 0.1,
    abilities: {0: 'Smother Body'},
  },
  'Tofrug': {
    types: ['Poison', 'Fairy'],
    bs: {hp: 55, at: 50, df: 40, sa: 55, sd: 45, sp: 65},
    weightkg: 15.7,
    abilities: {0: 'Poison Coat'},
    nfe: true,
  },
  'Kaskazog': {
    types: ['Poison', 'Fairy'],
    bs: {hp: 75, at: 90, df: 65, sa: 110, sd: 70, sp: 110},
    weightkg: 38,
    abilities: {0: 'Poison Coat'},
  },
  'Ananot': {
    types: ['Poison'],
    bs: {hp: 60, at: 25, df: 30, sa: 35, sd: 33, sp: 27},
    weightkg: 6.3,
    abilities: {0: 'Dry Skin'},
    nfe: true,
  },
  'Ananoop': {
    types: ['Poison'],
    bs: {hp: 100, at: 50, df: 60, sa: 90, sd: 70, sp: 50},
    weightkg: 18.9,
    abilities: {0: 'Dry Skin'},
  },
  'Mosster': {
    types: ['Grass'],
    bs: {hp: 55, at: 60, df: 85, sa: 60, sd: 75, sp: 55},
    weightkg: 3.4,
    abilities: {0: 'Rain Dish'},
    nfe: true,
  },
  'Mosskrat': {
    types: ['Grass', 'Water'],
    bs: {hp: 100, at: 70, df: 90, sa: 90, sd: 80, sp: 65},
    weightkg: 18.5,
    abilities: {0: 'Rain Dish'},
  ...
  'Catteraxe': {
    types: ['Steel', 'Normal'],
    bs: {hp: 40, at: 90, df: 40, sa: 70, sd: 40, sp: 50},
    weightkg: 5.7,
    abilities: {0: 'Reckless'},
    nfe: true,
  },
  'Catatomb': {
    types: ['Ghost', 'Normal'],
    bs: {hp: 70, at: 110, df: 60, sa: 110, sd: 90, sp: 60},
    weightkg: 22.6,
    abilities: {0: 'Warp Mist'},
  },
  'Enigmeon': {
    types: ['Normal'],
    bs: {hp: 130, at: 65, df: 65, sa: 95, sd: 110, sp: 60},
    weightkg: 22.5,
    abilities: {0: 'Warp Mist'},
  },
  'Skinka': {
    types: ['Normal'],
    bs: {hp: 55, at: 55, df: 65, sa: 45, sd: 50, sp: 55},
    weightkg: 5.6,
    abilities: {0: 'Adaptability'},
    nfe: true,
  },
  'Dredgen': {
    types: ['Ground'],
    bs: {hp: 70, at: 135, df: 95, sa: 55, sd: 55, sp: 115},
    weightkg: 93.5,
    abilities: {0: 'Intimidate'},
  },
  'Stalagen': {
    types: ['Rock'],
    bs: {hp: 115, at: 95, df: 135, sa: 55, sd: 55, sp: 70},
    weightkg: 88,
    abilities: {0: 'Rock Head'},
  },
  'Chromagen': {
    types: ['Steel'],
    bs: {hp: 135, at: 55, df: 115, sa: 70, sd: 95, sp: 55},
    weightkg: 105,
    abilities: {0: 'Iron Barbs'},
  },
  'Aerogen': {
    types: ['Flying'],
    bs: {hp: 55, at: 95, df: 55, sa: 115, sd: 70, sp: 135},
    weightkg: 55,
    abilities: {0: 'Prankster'},
  },
  'Caragen': {
    types: ['Bug'],
    bs: {hp: 55, at: 115, df: 135, sa: 55, sd: 70, sp: 95},
    weightkg: 70,
    abilities: {0: 'Tinted Lens'},
  },
  'Bludgen': {
    types: ['Fighting'],
    bs: {hp: 95, at: 135, df: 115, sa: 55, sd: 55, sp: 70},
    weightkg: 97,
    abilities: {0: 'Guts'},
  },
  'Pathagen': {
    types: ['Poison'],
    bs: {hp: 95, at: 55, df: 70, sa: 115, sd: 135, sp: 55},
    weightkg: 90,
    abilities: {0: 'Poison Coat'},
  },
  'Ectogen': {
    types: ['Ghost'],
    bs: {hp: 55, at: 70, df: 55, sa: 135, sd: 95, sp: 115},
    weightkg: 0.4,
    abilities: {0: 'Shadow Tag'},
  },
  'Legen': {
    types: ['Dragon'],
    bs: {hp: 135, at: 115, df: 55, sa: 70, sd: 55, sp: 95},
    weightkg: 65,
    abilities: {0: 'Multiscale'},
  },
  'Depuray': {
    types: ['Fighting', 'Ground'],
    bs: {hp: 50, at: 100, df: 40, sa: 35, sd: 40, sp: 50},
    weightkg: 9,
    abilities: {0: 'Defiant'},
    nfe: true,
  },
  'Desoray': {
    types: ['Fighting', 'Ground'],
    bs: {hp: 90, at: 125, df: 80, sa: 50, sd: 80, sp: 95},
    weightkg: 250,
    abilities: {0: 'Defiant'},
  },
  'Dirrun': {
    types: ['Ground'],
    bs: {hp: 65, at: 60, df: 55, sa: 35, sd: 55, sp: 70},
    weightkg: 4,
    abilities: {0: 'Sand Rush'},
    nfe: true,
  },
  'Blurrun': {
    types: ['Ground'],
    bs: {hp: 80, at: 110, df: 75, sa: 75, sd: 75, sp: 125},
    weightkg: 39,
  ...
  'Blurrun-Charged': {
    types: ['Ground', 'Electric'],
    bs: {hp: 80, at: 75, df: 55, sa: 160, sd: 55, sp: 125},
    weightkg: 39,
    abilities: {0: 'Power Plumage'},
    baseSpecies: 'Blurrun',
  },
  'Pudet': {
    types: ['Fighting'],
    bs: {hp: 55, at: 75, df: 55, sa: 25, sd: 55, sp: 65},
    weightkg: 12,
    abilities: {0: 'Scrappy'},
    nfe: true,
  },
  'Woond': {
    types: ['Ghost', 'Fighting'],
    bs: {hp: 75, at: 115, df: 60, sa: 80, sd: 90, sp: 100},
    weightkg: 39.5,
    abilities: {0: 'Scrappy'},
  },
  'Pramblo': {
    types: ['Fire', 'Ground'],
    bs: {hp: 60, at: 70, df: 15, sa: 50, sd: 75, sp: 60},
    weightkg: 1.5,
    abilities: {0: 'Earth Force'},
    nfe: true,
  },
  'Glashulimp': {
    types: ['Fire', 'Ground'],
    bs: {hp: 85, at: 120, df: 30, sa: 65, sd: 110, sp: 90},
    weightkg: 17,
    abilities: {0: 'Earth Force'},
  },
  'Drout': {
    types: ['Water', 'Ground'],
    bs: {hp: 90, at: 60, df: 60, sa: 105, sd: 80, sp: 110},
    weightkg: 90,
  ...
  'Drout-Dry': {
    types: ['Rock', 'Ground'],
    bs: {hp: 90, at: 95, df: 105, sa: 60, sd: 105, sp: 50},
    weightkg: 82,
    abilities: {0: 'Wet and Dry'},
    baseSpecies: 'Drout',
  },
  'Guruchi': {
    types: ['Water', 'Electric'],
    bs: {hp: 70, at: 50, df: 70, sa: 110, sd: 70, sp: 90},
    weightkg: 19,
    abilities: {0: 'Water Absorb'},
  },
  'Porygon ω': {
    types: ['Normal'],
    bs: {hp: 100, at: 60, df: 90, sa: 110, sd: 95, sp: 80},
    weightkg: 75,
    abilities: {0: 'Surveillance'},
  },
  'Estoe': {
    types: ['Psychic', 'Poison'],
    bs: {hp: 91, at: 41, df: 89, sa: 71, sd: 89, sp: 31},
    weightkg: 22,
    abilities: {0: 'Geiger Aura'},
    nfe: true,
  },
  'Perpetua': {
    types: ['Psychic', 'Poison'],
    bs: {hp: 101, at: 47, df: 101, sa: 89, sd: 101, sp: 89},
    weightkg: 45,
    abilities: {0: 'Geiger Aura'},
  },
  'Tooburm': {
    types: ['Ground', 'Electric'],
    bs: {hp: 35, at: 40, df: 69, sa: 60, sd: 51, sp: 55},
    weightkg: 310,
  ...
  'Detrarc': {
    types: ['Ground', 'Electric'],
    bs: {hp: 70, at: 65, df: 79, sa: 95, sd: 61, sp: 80},
    weightkg: 450,
    abilities: {0: 'Energizer'},
  },
  'Qayagus': {
    types: ['Poison', 'Psychic'],
    bs: {hp: 70, at: 75, df: 90, sa: 90, sd: 125, sp: 30},
    weightkg: 480,
    abilities: {0: 'Poison Coat'},
  },
  'Auditaur': {
    types: ['Normal'],
    bs: {hp: 48, at: 58, df: 50, sa: 19, sd: 55, sp: 55},
    weightkg: 285,
    abilities: {0: 'Cud Chew'},
    nfe: true,
  },
  'Oxillery': {
    ...
    bs: {hp: 85, at: 110, df: 75, sa: 30, sd: 75, sp: 102},
    weightkg: 477,
    abilities: {0: 'Cud Chew'},
  },
  'Mienflux': {
    types: ['Fighting', 'Electric'],
    bs: {hp: 65, at: 95, df: 50, sa: 125, sd: 50, sp: 125},
    weightkg: 510,
    abilities: {0: 'Forked'},
  },
  'Gneckle': {
    types: ['Dark'],
    bs: {hp: 40, at: 90, df: 45, sa: 30, sd: 45, sp: 30},
    weightkg: 280,
    abilities: {0: 'Suction Cups'},
    nfe: true,
  },
  'Rabyoose': {
    types: ['Dark', 'Flying'],
    bs: {hp: 70, at: 120, df: 75, sa: 65, sd: 75, sp: 105},
    weightkg: 510,
    abilities: {0: 'Moxie'},
  },
  'Avokiddo': {
    types: ['Grass', 'Poison'],
    bs: {hp: 60, at: 60, df: 60, sa: 50, sd: 60, sp: 60},
    weightkg: 280,
    abilities: {0: 'Harvest'},
    nfe: true,
  },
  'Alliguaca': {
    types: ['Grass', 'Poison'],
    bs: {hp: 90, at: 95, df: 80, sa: 75, sd: 80, sp: 60},
    weightkg: 280,
    abilities: {0: 'Harvest'},
  },
  'Tamroast': {
    types: ['Fire', 'Fairy'],
    bs: {hp: 80, at: 45, df: 100, sa: 100, sd: 100, sp: 70},
    weightkg: 495,
    abilities: {0: 'Insomnia'},
  ...
  'Weepollen': {
    types: ['Bug', 'Fairy'],
    bs: {hp: 60, at: 50, df: 80, sa: 90, sd: 90, sp: 75},
    weightkg: 495,
    abilities: {0: 'Bloomspring'},
  ...
  'Weepollen-F': {
    ...
    bs: {hp: 60, at: 50, df: 80, sa: 90, sd: 90, sp: 75},
    weightkg: 495,
    abilities: {0: 'Secretion'},
    baseSpecies: 'Weepollen',
  },
  'Vitisquash': {
    types: ['Normal', 'Grass'],
    bs: {hp: 100, at: 85, df: 70, sa: 45, sd: 70, sp: 50},
    weightkg: 420,
    abilities: {0: 'Ripen'},
    nfe: true,
  },
  'Dionysseur': {
    types: ['Poison', 'Grass'],
    bs: {hp: 110, at: 120, df: 90, sa: 80, sd: 90, sp: 75},
    weightkg: 565,
    abilities: {0: 'Ripen'},
  },
  'Umbralu': {
    types: ['Dark', 'Water'],
    bs: {hp: 55, at: 70, df: 50, sa: 110, sd: 65, sp: 100},
    weightkg: 450,
    abilities: {0: 'Petrichor'},
  },
  'Nomobjeka': {
    types: ['Fighting', 'Fairy'],
    bs: {hp: 80, at: 95, df: 60, sa: 95, sd: 70, sp: 90},
    weightkg: 490,
    abilities: {0: 'Defiant'},
  },
  'Kleptarak': {
    types: ['Bug', 'Dark'],
    bs: {hp: 60, at: 110, df: 50, sa: 40, sd: 105, sp: 90},
    weightkg: 455,
    abilities: {0: 'Nasty Webbing'},
  },
  'Kituff': {
    types: ['Fighting'],
    bs: {hp: 50, at: 65, df: 35, sa: 35, sd: 35, sp: 65},
    weightkg: 285,
    abilities: {0: 'Technician'},
    nfe: true,
  },
  'Beadamup': {
    types: ['Fighting', 'Steel'],
    bs: {hp: 70, at: 130, df: 60, sa: 90, sd: 60, sp: 115},
    weightkg: 525,
    abilities: {0: 'Technician'},
  },
  'Rascume': {
    types: ['Fire', 'Steel'],
    bs: {hp: 75, at: 105, df: 60, sa: 55, sd: 60, sp: 115},
    weightkg: 470,
    abilities: {0: 'Carbon Capture'},
  },
  'Faebril': {
    types: ['Electric', 'Fairy'],
    bs: {hp: 180, at: 10, df: 60, sa: 60, sd: 110, sp: 60},
    weightkg: 480,
    abilities: {0: 'Healer'},
  },
  'Bokshel': {
    types: ['Normal'],
    bs: {hp: 60, at: 50, df: 75, sa: 30, sd: 60, sp: 20},
    weightkg: 285,
    abilities: {0: 'Unaware'},
    nfe: true,
  },
  'Hermirt': {
    types: ['Normal'],
    bs: {hp: 80, at: 80, df: 130, sa: 50, sd: 100, sp: 40},
    weightkg: 525,
    abilities: {0: 'Weak Armor'},
  },
  'Aeradio': {
    types: ['Flying'],
    bs: {hp: 65, at: 85, df: 70, sa: 95, sd: 75, sp: 100},
    weightkg: 490,
    abilities: {0: 'Galeforce'},
  },
  'Hurchin': {
    types: ['Water', 'Fire'],
    bs: {hp: 60, at: 105, df: 75, sa: 100, sd: 55, sp: 10},
    weightkg: 490,
    abilities: {0: 'Anxiety'},
  },
  'Botnyak': {
    types: ['Steel'],
    bs: {hp: 55, at: 30, df: 70, sa: 110, sd: 105, sp: 116},
    weightkg: 486,
    abilities: {0: 'Trace'},
  },
  'Vendrom': {
    types: ['Water', 'Fire'],
    bs: {hp: 110, at: 65, df: 130, sa: 85, sd: 75, sp: 45},
    weightkg: 510,
    abilities: {0: 'Ancient Body'},
  },
  'Buwuve': {
    types: ['Water'],
    bs: {hp: 40, at: 60, df: 45, sa: 40, sd: 45, sp: 70},
    weightkg: 300,
    abilities: {0: 'Malice'},
    nfe: true,
  },
  'Wasgrowl': {
    types: ['Water', 'Dragon'],
    bs: {hp: 60, at: 90, df: 60, sa: 50, sd: 60, sp: 90},
    weightkg: 410,
    abilities: {0: 'Malice'},
    nfe: true,
  },
  'Worcane': {
    types: ['Water', 'Dragon'],
    bs: {hp: 80, at: 140, df: 75, sa: 110, sd: 75, sp: 120},
    weightkg: 600,
    abilities: {0: 'Malice'},
  },
  'Probat': {
    types: ['Psychic', 'Flying'],
    bs: {hp: 85, at: 60, df: 75, sa: 105, sd: 80, sp: 130},
    weightkg: 535,
    abilities: {0: 'Surveillance'},
  },
  'Jemineye': {
    types: ['Rock', 'Psychic'],
    bs: {hp: 75, at: 30, df: 60, sa: 120, sd: 60, sp: 20},
    weightkg: 25,
    abilities: {0: 'Solid Rock'},
  },
  'Oracub': {
    types: ['Ghost', 'Psychic'],
    bs: {hp: 80, at: 50, df: 50, sa: 70, sd: 90, sp: 20},
    weightkg: 8.5,
    abilities: {0: 'Inner Focus'},
    nfe: true,
  },
  'Bearvoyance': {
    types: ['Ghost', 'Psychic'],
    bs: {hp: 100, at: 50, df: 90, sa: 100, sd: 110, sp: 50},
    weightkg: 260,
    abilities: {0: 'Consecration'},
    otherFormes: ['Bearvoyance-Awakened'],
  },
  'Bearvoyance-Awakened': {
    types: ['Ghost', 'Psychic'],
    bs: {hp: 100, at: 50, df: 120, sa: 130, sd: 140, sp: 60},
    weightkg: 260,
    abilities: {0: 'Consecration'},
  ...
  'Folleming': {
    types: ['Electric', 'Psychic'],
    bs: {hp: 80, at: 60, df: 80, sa: 110, sd: 60, sp: 95},
    weightkg: 485,
    abilities: {0: 'Enjoin'},
  },
  'Drosabell': {
    types: ['Grass', 'Psychic'],
    bs: {hp: 85, at: 80, df: 70, sa: 100, sd: 80, sp: 35},
    weightkg: 450,
    abilities: {0: 'Flytrap'},
  },
  'Yanmage': {
    types: ['Bug', 'Dragon'],
    bs: {hp: 90, at: 70, df: 55, sa: 120, sd: 90, sp: 90},
    weightkg: 515,
    abilities: {0: 'Power Within'},
  },
  'Bloomage': {
    types: ['Fire', 'Grass'],
    bs: {hp: 75, at: 70, df: 75, sa: 120, sd: 75, sp: 105},
    weightkg: 520,
    abilities: {0: 'Vegetate'},
  },
  'Obsidious': {
    types: ['Rock', 'Dark'],
    bs: {hp: 70, at: 105, df: 75, sa: 90, sd: 80, sp: 60},
    weightkg: 520,
    abilities: {0: 'Sharpness'},
  },
  'Mercryni': {
    types: ['Steel', 'Poison'],
    bs: {hp: 95, at: 30, df: 75, sa: 75, sd: 65, sp: 50},
    weightkg: 390,
    abilities: {0: 'Corrosion'},
    nfe: true,
  },
  'Meraculisk': {
    types: ['Steel', 'Poison'],
    bs: {hp: 125, at: 70, df: 80, sa: 105, sd: 80, sp: 80},
    weightkg: 540,
    abilities: {0: 'Corrosion'},
  },
  'Golgre': {
    types: ['Ghost', 'Rock'],
    bs: {hp: 89, at: 55, df: 80, sa: 124, sd: 80, sp: 55},
    weightkg: 483,
    abilities: {0: 'Shadow Step'},
  },
  'Prospectre': {
    types: ['Ghost', 'Rock'],
    bs: {hp: 70, at: 110, df: 50, sa: 90, sd: 50, sp: 65},
    weightkg: 435,
    abilities: {0: 'Songbird'},
  },
  'Skideer': {
    types: ['Ice'],
    bs: {hp: 50, at: 40, df: 65, sa: 20, sd: 80, sp: 100},
    weightkg: 355,
    abilities: {0: 'Pixilate'},
    nfe: true,
  },
  'Yuleigh': {
    types: ['Ice', 'Fairy'],
    bs: {hp: 70, at: 100, df: 80, sa: 30, sd: 90, sp: 155},
    weightkg: 525,
    abilities: {0: 'Pixilate'},
  },
  'Feafurr': {
    types: ['Ice', 'Fire'],
    bs: {hp: 40, at: 60, df: 50, sa: 50, sd: 20, sp: 40},
    weightkg: 260,
    abilities: {0: 'Frigid Blaze'},
    nfe: true,
  },
  'Vaicear': {
    types: ['Ice', 'Fire'],
    bs: {hp: 85, at: 133, df: 70, sa: 103, sd: 35, sp: 104},
    weightkg: 530,
    abilities: {0: 'Frigid Blaze'},
  },
  'Phisnooz': {
    types: ['Ice', 'Psychic'],
    bs: {hp: 50, at: 30, df: 50, sa: 55, sd: 45, sp: 30},
    weightkg: 260,
    abilities: {0: 'Smoke and Mirrors'},
    nfe: true,
  },
  'Telemac': {
    types: ['Ice', 'Psychic'],
    bs: {hp: 105, at: 75, df: 85, sa: 110, sd: 85, sp: 70},
    weightkg: 530,
    abilities: {0: 'Smoke and Mirrors'},
  },
  'Macedontus': {
    types: ['Ice', 'Ground'],
    bs: {hp: 100, at: 130, df: 90, sa: 80, sd: 90, sp: 40},
    weightkg: 530,
    abilities: {0: 'Glacial Armor'},
  },
  'Crynorawst': {
    types: ['Ice', 'Rock'],
    bs: {hp: 110, at: 100, df: 100, sa: 70, sd: 60, sp: 90},
    weightkg: 530,
    abilities: {0: 'Absolute Zero'},
  },
  'Rotomb': {
    types: ['Electric', 'Ghost'],
    bs: {hp: 50, at: 108, df: 108, sa: 108, sd: 108, sp: 108},
    weightkg: 590,
    abilities: {0: 'Levitate'},
  },
  'Tamunk': {
    types: ['Fairy', 'Grass'],
    bs: {hp: 110, at: 85, df: 85, sa: 110, sd: 110, sp: 100},
    weightkg: 600,
    abilities: {0: 'Arena Bloom'},
  },
  'Temunk': {
    types: ['Ghost', 'Grass'],
    bs: {hp: 100, at: 110, df: 110, sa: 85, sd: 85, sp: 110},
    weightkg: 600,
    abilities: {0: 'Arena Curse'},
  },
  'Manadza': {
    types: ['Fire', 'Psychic'],
    bs: {hp: 105, at: 75, df: 90, sa: 160, sd: 130, sp: 120},
    weightkg: 680,
    abilities: {0: 'Heat Haze'},
  },
  'Arctikull': {
    types: ['Ice', 'Dark'],
    bs: {hp: 105, at: 160, df: 130, sa: 95, sd: 95, sp: 95},
    weightkg: 680,
    abilities: {0: 'Ice Armor'},
  },
  'Wicoot': {
    types: ['Psychic', 'Dark'],
    bs: {hp: 80, at: 90, df: 90, sa: 125, sd: 125, sp: 90},
    weightkg: 600,
    abilities: {0: 'Neutralize'},
  },
  'Ωrogon': {
    types: ['Electric', 'Steel'],
    bs: {hp: 110, at: 80, df: 110, sa: 155, sd: 110, sp: 115},
    weightkg: 680,
    abilities: {0: 'Relic Soul'},
  },
  'Orbtholod': {
    types: ['Psychic', 'Dark'],
    bs: {hp: 80, at: 40, df: 80, sa: 130, sd: 120, sp: 100},
    weightkg: 550,
    abilities: {0: 'Magic Bounce'},
  },
  'Pestalation': {
    types: ['Flying', 'Poison'],
    bs: {hp: 111, at: 111, df: 111, sa: 111, sd: 111, sp: 111},
    weightkg: 666,
    abilities: {0: 'Steelworker'},
  },
  'Revylon': {
    types: ['Ground', 'Fire'],
    bs: {hp: 109, at: 73, df: 101, sa: 143, sd: 109, sp: 131},
    weightkg: 666,
    abilities: {0: 'Mega Launcher'},
  },
  'Leoseace': {
    types: ['Water', 'Dark'],
    bs: {hp: 157, at: 113, df: 97, sa: 101, sd: 71, sp: 127},
    weightkg: 666,
    abilities: {0: 'Soul Passage'},
  },
  'Lamentu': {
    types: ['Fire', 'Psychic'],
    bs: {hp: 113, at: 71, df: 79, sa: 149, sd: 117, sp: 137},
    weightkg: 666,
    abilities: {0: 'Expiation'},
  },
  'Endram-Odai': {
    types: ['Dragon', 'Fairy'],
    bs: {hp: 157, at: 73, df: 107, sa: 173, sd: 137, sp: 89},
    weightkg: 766,
    abilities: {0: 'Pressure'},
  },
};
Object.assign(SV, SWSE_SPECIES);
