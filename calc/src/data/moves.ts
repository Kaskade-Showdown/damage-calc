...
// swse
const SWSE_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  'Blood Moon': {bp: 0, type: 'Dark'},
  'Foghorn': {bp: 0, type: 'Normal'},
  'Dust Storm': {bp: 0, type: 'Ground', isWind: true},
  'Pollinate': {bp: 0, type: 'Grass', isWind: true},
  'Swarm Signal': {bp: 0, type: 'Bug', isWind: true},
  'Smog Spread': {bp: 0, type: 'Poison', isSound: true, isWind: true},
  'Sprinkle': {bp: 0, type: 'Fairy', isWind: true},
  'Aura Projection': {bp: 0, type: 'Fighting', isSound: true},
  'Haunt': {bp: 0, type: 'Ghost'},
  'Daydream': {bp: 0, type: 'Psychic'},
  'Dragon Force': {bp: 0, type: 'Dragon'},
  'Supercell': {bp: 0, type: 'Electric', isWind: true},
  'Magnetize': {bp: 0, type: 'Steel'},
  'Strong Winds': {bp: 0, type: 'Flying', isWind: true},
  'Battle Cry': {bp: 40, type: 'Normal', category: 'Special', isSound: true, target: 'allAdjacentFoes'},
  'Snooze': {bp: 0, type: 'Normal', isSound: true},
  'Ki-hop': {bp: 65, type: 'Fighting', category: 'Special', makesContact: true, isSound: true},
  'Wind Tunnel': {bp: 60, type: 'Flying', category: 'Physical', makesContact: true, isWind: true},
  'Windrage': {bp: 110, type: 'Flying', category: 'Physical', makesContact: true, isWind: true},
  'Whip Up': {bp: 90, type: 'Flying', category: 'Special', isWind: true},
  'Muck Volley': {bp: 20, type: 'Poison', category: 'Special', multihit: 3},
  'Viral Blast': {bp: 120, type: 'Poison', category: 'Special', makesContact: true},
  'Earth Rush': {bp: 50, type: 'Ground', category: 'Physical', makesContact: true, secondaries: true},
  'Sandblast': {bp: 50, type: 'Ground', category: 'Special'},
  'Rock Jaw': {bp: 80, type: 'Rock', category: 'Physical', makesContact: true, isBite: true},
  'Stone Storm': {bp: 50, type: 'Rock', category: 'Special'},
  'Crystal Force': {bp: 120, type: 'Rock', category: 'Special', recoil: [33, 100]},
  'Hive Shriek': {bp: 120, type: 'Bug', category: 'Special', isSound: true},
  'Shadow Spit': {bp: 40, type: 'Ghost', category: 'Special'},
  'Ectoplasma': {bp: 120, type: 'Ghost', category: 'Special'},
  'Hydraulic Jaw': {bp: 90, type: 'Steel', category: 'Physical', makesContact: true, isBite: true},
  'Spectrum': {bp: 40, type: 'Steel', category: 'Special'},
  'Conduction': {bp: 80, type: 'Steel', category: 'Special'},
  'Shredding Riff': {bp: 110, type: 'Steel', category: 'Special', isSound: true},
  'Steel Barbs': {bp: 0, type: 'Steel'},
  'Kindle': {bp: 40, type: 'Fire', category: 'Physical', makesContact: true, secondaries: true},
  'Lava Jet': {bp: 40, type: 'Fire', category: 'Physical', makesContact: true, priority: 1},
  'Ignition': {bp: 90, type: 'Fire', category: 'Physical', makesContact: true},
  'Ember Plume': {bp: 100, type: 'Fire', category: 'Special'},
  'Sunscreen': {bp: 0, type: 'Fire'},
  'Paddle': {bp: 40, type: 'Water', category: 'Physical', makesContact: true},
  'Osmosis': {bp: 75, type: 'Water', category: 'Special'},
  'Escape Root': {bp: 0, type: 'Grass'},
  'Cider Cannon': {bp: 0, type: 'Grass'},
  'Volt Kick': {bp: 85, type: 'Electric', category: 'Physical', makesContact: true},
  'Psychic Clap': {bp: 40, type: 'Psychic', category: 'Physical', makesContact: true, isPulse: true},
  'Psion Rush': {bp: 120, type: 'Psychic', category: 'Physical', makesContact: true},
  'Mind Meld': {bp: 120, type: 'Psychic', category: 'Special'},
  'Psycho Cannon': {bp: 150, type: 'Psychic', category: 'Special', isPulse: true},
  'Ice Break': {bp: 50, type: 'Ice', category: 'Physical', makesContact: true},
  'Frost Kick': {bp: 85, type: 'Ice', category: 'Physical', makesContact: true, secondaries: true},
  'Permafrost': {bp: 120, type: 'Ice', category: 'Physical', makesContact: true},
  'Slushball': {bp: 60, type: 'Ice', category: 'Special', isBullet: true},
  'White Wand': {bp: 0, type: 'Ice'},
  'Draconic Orb': {bp: 60, type: 'Dragon', category: 'Special', isBullet: true},
  'Draconic Roar': {bp: 90, type: 'Dragon', category: 'Special', isSound: true, target: 'allAdjacentFoes'},
  'Initiative': {bp: 0, type: 'Dragon'},
  'Mockery': {bp: 20, type: 'Dark', category: 'Special', isSound: true, multihit: [1, 2]},
  'Shade': {bp: 50, type: 'Dark', category: 'Special'},
  'Deception': {bp: 80, type: 'Dark', category: 'Special'},
  'Black Hole': {bp: 120, type: 'Dark', category: 'Special'},
  'Bear Hug': {bp: 30, type: 'Fairy', category: 'Physical', makesContact: true},
  'Pixie Punch': {bp: 65, type: 'Fairy', category: 'Physical', makesContact: true, isPunch: true},
  'Peek-a-Boo': {bp: 60, type: 'Fairy', category: 'Physical', makesContact: true},
  'Excalibur': {bp: 120, type: 'Fairy', category: 'Physical', makesContact: true, isSlicing: true},
  'Magic Missile': {bp: 30, type: 'Fairy', category: 'Special', isPulse: true, multihit: 3},
  'Wild Magic': {bp: 60, type: 'Fairy', category: 'Special'},
  'Lunar Surge': {bp: 120, type: 'Fairy', category: 'Special'},
  'Lovespray': {bp: 0, type: 'Fairy'},
  'Fluff Buff': {bp: 0, type: 'Grass'},
  'Thermal Vortex': {bp: 70, type: 'Fire', category: 'Physical', target: 'allAdjacentFoes'},
  'Whirlduel': {bp: 80, type: 'Water', category: 'Special', makesContact: true},
  'Brainstorm': {bp: 0, type: 'Psychic'},
  'Possess': {bp: 35, type: 'Ghost', category: 'Special'},
  'Evoboost': {bp: 0, type: 'Normal'},
  'Wrangle': {bp: 80, type: 'Fighting', category: 'Physical'},
  'Shadow Fang': {bp: 85, type: 'Ghost', category: 'Physical', makesContact: true, isBite: true},
  'Prickly Pear': {bp: 0, type: 'Grass'},
  'Sandstone Sweep': {bp: 100, type: 'Rock', category: 'Physical'},
  'Hydrocharge': {bp: 100, type: 'Water', category: 'Special'},
  'Juice Drink': {bp: 0, type: 'Grass'},
  'Dark Depletion': {bp: 70, type: 'Dark', category: 'Special', isBite: true},
  "Comrade's Armor": {bp: 0, type: 'Normal', priority: 4},
  'Roller Blitz': {bp: 70, type: 'Steel', category: 'Physical', makesContact: true, overrideOffensiveStat: 'spe'},
  'Scavenge': {bp: 55, type: 'Steel', category: 'Physical', makesContact: true},
  'Sultry Spin': {bp: 60, type: 'Fighting', category: 'Physical', makesContact: true, target: 'allAdjacentFoes'},
  'Stunning Solo': {bp: 80, type: 'Electric', category: 'Special', isSound: true},
  'Heartshock': {bp: 0, type: 'Electric', priority: -6},
  'Shock Shelter': {bp: 0, type: 'Electric', priority: 4},
  "Dragon's Dice": {bp: 80, type: 'Dragon', category: 'Special'},
  'Deviled Yolk': {bp: 25, type: 'Grass', category: 'Special', multihit: [2, 5]},
  'Fire Glass': {bp: 90, type: 'Rock', category: 'Physical', makesContact: true, isSlicing: true},
  'Ferrospike Barrage': {bp: 110, type: 'Steel', category: 'Special'},
  'Resilient Oil': {bp: 0, type: 'Rock'},
  'Frostburn Claw': {bp: 80, type: 'Ice', category: 'Physical', makesContact: true},
  'Overbearing Command': {bp: 0, type: 'Psychic'},
  'Frostification': {bp: 0, type: 'Ice', priority: 4},
  'Glacial Charge': {bp: 100, type: 'Ice', category: 'Physical', makesContact: true},
  'Technoplasm': {bp: 20, type: 'Electric', category: 'Special', multihit: [2, 5]},
  'Efflorescence': {bp: 0, type: 'Fairy'},
  'Languishing Aura': {bp: 0, type: 'Ghost'},
  'Wildfire': {bp: 90, type: 'Fire', category: 'Special', target: 'allAdjacentFoes'},
  'Whiteout': {bp: 90, type: 'Ice', category: 'Physical', makesContact: true, target: 'allAdjacentFoes'},
  'Hornswongle': {bp: 0, type: 'Dark', priority: 3},
  'Amaze-Assault': {bp: 90, type: 'Steel', category: 'Special'},
  'Blight Spore': {bp: 0, type: 'Poison'},
  'Sulphur Beam': {bp: 85, type: 'Ground', category: 'Special', isPulse: true},
  // move updates
  'Arm Thrust': {bp: 25},
  'Armor Cannon': {isPulse: true},
  'Bitter Malice': {bp: 60},
  'Cut': {type: 'Steel', bp: 70},
  'Diamond Storm': {category: 'Special'},
  'False Swipe': {bp: 60},
  'Flash Cannon': {isPulse: true},
  'Glaive Rush': {isSlicing: true},
  'Hydro Cannon': {isPulse: true},
  'Light of Ruin': {recoil: [1, 3]},
  'Poison Jab': {isPunch: true},
  'Strength': {type: 'Fighting'},
  'Supercell Slam': {bp: 120},
  'Triple Kick': {bp: 20},
  'Volt Tackle': {bp: 150},
  'Wild Charge': {bp: 100, recoil: [1, 3]},
  'Zap Cannon': {isPulse: true},
};

const SV: {[name: string]: MoveData} = extend(true, {}, SS, SV_PATCH, ZA_PATCH, SWSE_PATCH);
