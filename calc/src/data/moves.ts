...
const SWSE_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Battle Cry': {
    bp: 40, type: 'Normal', category: 'Special', isSound: true, target: 'allAdjacentFoes',
  },
  ...
  'Earth Rush': {
    bp: 50, type: 'Ground', category: 'Physical', makesContact: true, secondaries: true,
  },
  ...
  'Psychic Clap': {
    bp: 40, type: 'Psychic', category: 'Physical', makesContact: true, isPulse: true,
  },
  ...
  'Draconic Roar': {
    bp: 90, type: 'Dragon', category: 'Special', isSound: true, target: 'allAdjacentFoes',
  },
  ...
  'Roller Blitz': {
    bp: 70, type: 'Steel', category: 'Physical', makesContact: true, overrideOffensiveStat: 'spe',
  },
  'Scavenge': {bp: 55, type: 'Steel', category: 'Physical', makesContact: true},
  'Sultry Spin': {
    bp: 60, type: 'Fighting', category: 'Physical', makesContact: true, target: 'allAdjacentFoes',
  },
  ...
  'Whiteout': {
    bp: 90, type: 'Ice', category: 'Physical', makesContact: true, target: 'allAdjacentFoes',
  },
